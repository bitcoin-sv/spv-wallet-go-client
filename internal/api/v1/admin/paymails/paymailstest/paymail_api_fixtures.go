...
func ExpectedCreatedPaymail(t *testing.T) *response.PaymailAddress {
	return &response.PaymailAddress{
		Model: response.Model{
			CreatedAt: spvwallettest.ParseTime(t, "2024-12-02T10:22:45.263654Z"),
			UpdatedAt: spvwallettest.ParseTime(t, "2024-12-02T11:22:45.263664+01:00"),
		},
...
func ExpectedPaymail(t *testing.T) *response.PaymailAddress {
	return &response.PaymailAddress{
		Model: response.Model{
			CreatedAt: spvwallettest.ParseTime(t, "2024-10-02T10:28:15.544234Z"),
			UpdatedAt: spvwallettest.ParseTime(t, "2024-10-02T10:34:54.836433Z"),
		},
...
func ExpectedPaymailsPage(t *testing.T) *queries.PaymailAddressPage {
	return &queries.PaymailAddressPage{
		Content: []*response.PaymailAddress{
			{
				Model: response.Model{
					CreatedAt: spvwallettest.ParseTime(t, "2024-11-18T06:50:07.144902Z"),
					UpdatedAt: spvwallettest.ParseTime(t, "2024-11-18T06:50:07.144932Z"),
				},
			...
			{
				Model: response.Model{
					CreatedAt: spvwallettest.ParseTime(t, "2024-11-08T15:10:44.688653Z"),
					UpdatedAt: spvwallettest.ParseTime(t, "2024-11-18T07:19:51.561691Z"),
				},
