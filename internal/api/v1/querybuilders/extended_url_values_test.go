...
func TestExtendedURLValues_AddPair(t *testing.T) {
	// given:
	to := spvwallettest.ParseTime(t, "2024-10-07T14:03:26.736816Z")
	from := spvwallettest.ParseTime(t, "2024-10-07T14:03:26.736816Z")
	...
	params.AddPair("key3", spvwallettest.Ptr("str_ptr"))
	params.AddPair("key4", spvwallettest.Ptr(uint64(64)))
	params.AddPair("key5", spvwallettest.Ptr(uint32(32)))
	params.AddPair("key6", spvwallettest.Ptr(bool(false)))
