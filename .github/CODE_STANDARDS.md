...
- [Code Standards \& Contributing Guidelines](#code-standards--contributing-guidelines-1)
  - [Most important rules - Quick Checklist](#most-important-rules---quick-checklist-1)
  - [1 Code style and formatting - official guidelines](#1-code-style-and-formatting---official-guidelines-1)
    - [1.1 In GO applications or libraries, we follow the official guidelines](#11-in-go-applications-or-libraries-we-follow-the-official-guidelines-1)
      - [Additional useful resources with GO recommendations, best practices and the common mistakes](#additional-useful-resources-with-go-recommendations-best-practices-and-the-common-mistakes-1)
  - [2 Code Rules](#2-code-rules-1)
    - [2.1. Self-documenting code](#21-self-documenting-code-1)
      - [As a Developer](#as-a-developer-1)
      - [As a PR Reviewer](#as-a-pr-reviewer-1)
    - [2.2 Tests](#22-tests-1)
      - [Principle](#principle-1)
      - [Guidelines for Writing Tests](#guidelines-for-writing-tests-1)
        - [Pull request title with a scope and task number](#pull-request-title-with-a-scope-and-task-number-1)
    - [3.3 Branching](#33-branching-1)
      - [Choosing branch names](#choosing-branch-names-1)
      - [Descriptiveness](#descriptiveness-1)
      - [Include Issue Number](#include-issue-number-1)
      - [Deleting Branches After Merging](#deleting-branches-after-merging-1)
      - [Remove Remote Branches](#remove-remote-branches-1)
      - [Recommendation: Clean Local Branches](#recommendation-clean-local-branches-1)
  - [4 Documentation Code Standards](#4-documentation-code-standards-1)
    - [4.1 Overview](#41-overview-1)
    - [4.2 Principles](#42-principles-1)
    - [4.3 Feature Documentation](#43-feature-documentation-1)
      - [Necessity](#necessity-1)
      - [Examples](#examples-1)
    - [4.4 External Features](#44-external-features-1)
    - [4.5 Markdown usage](#45-markdown-usage-1)
    - [4.6 Conclusion](#46-conclusion-1)
